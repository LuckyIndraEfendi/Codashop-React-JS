...
import CheckOutSkeletonLoading from "@/components/loading/checkout-skeleton-loading";
import { MotionDiv } from "@/components/motion";
import UserPlayInput from "@/components/user-player-input";
...
const CheckOut = () => {
  ...
  const { handleValidateCheckUserID } = useRootLayout();
  return (
    <>
      <main className="sm:w-[80%] mx-auto mt-4">
        {isLoading ? (
          <CheckOutSkeletonLoading />
        ) : (
          <div className="grid md:grid-cols-5 gap-5 ">
              ...
              <MotionDiv
                ...
                variants={{
                  ...
                  visible: () => ({
                    ...
                    scale: 1,
                    transition: {
                      delay: 0.2, // Delay setiap elemen sebesar 0.2 detik
                      ease: "easeInOut",
                      duration: 0.6,
                    },
                  }),
                ...
                <div>
                  ...
                  <div className="mt-5">
                    ...
                    <div className="mt-3 flex items-center gap-3">
                      <Link
                        to={"https://apps.apple.com/US/app/id1300146617?mt=8"}
                      >
                        <img
            ...
            <div className="md:col-span-3 flex flex-col gap-5">
              <MotionDiv
                ...
                variants={{
                  ...
                  visible: () => ({
                    ...
                    scale: 1,
                    transition: {
                      delay: 0.4, // Delay setiap elemen sebesar 0.2 detik
                      ease: "easeInOut",
                      duration: 0.6,
                    },
                  }),
                  ...
                  <div className="px-4 py-5 ">
                    <div>
                      <div className="user-id-input ">
                        ...
                        >
                          {data?.details_products?.user_player?.player_data?.map(
                            (item, i) => (
                              <UserPlayInput item={item} key={i} />
                            )
                          )}
                        </div>
                      </div>
              ...
              <MotionDiv
                ...
                variants={{
                  ...
                  visible: () => ({
                    ...
                    scale: 1,
                    transition: {
                      delay: 0.6, // Delay setiap elemen sebesar 0.2 detik
                      ease: "easeInOut",
                      duration: 0.6,
                    },
                  }),
              ...
              <Button
                className={cn("bg-blue-500 hover:bg-blue-600 h-10")}
                onClick={handleValidateCheckUserID}
              >
                CheckOut
              </Button>
            </div>
